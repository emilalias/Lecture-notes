...
Pour le sens $\Rightarrow$ on utilise le theoreme qui nous dit que le seul polynome egal a 0 est le polynome dont tous les coefficients valent 0. Comme $p(x)-q(x)=0$ on a que $a_{i}-b_{i}=0$ pour tous $i$ donc $a_{i}=b_{i}$.
