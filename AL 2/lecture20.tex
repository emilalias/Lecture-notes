...
\end{definition}
\begin{definition}
La matrice $A_{k}$ de $A\in \mathbf{R}^{m\times n}$ pour $k\in \mathbf{N}$ ou $A=P\mathrm{diag}(\sigma_{1},\dots,\sigma^{r},0,\dots,0)D$ est
$$
A_{k}=P\mathrm{diag}(\sigma_{1},\dots,\sigma _{k},0,\dots,0)D.
$$
