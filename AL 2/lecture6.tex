...
Soit \todo{Lecture 6} $f(x)\in K[x]$ un polynome et $A\in K^{n\times n}$ une matrice. On peut ecrire le polynome evalue en $A$ comme 
$$
...
$$
f(A)\cdot \boldsymbol{v}=\boldsymbol{0}
$$
\end{definition}
\begin{theorem}
...
Quelle est la probabilite que $p_{\boldsymbol{v}}(x):\mu _{1}\le \ell_{1}-1$?
