...
$$
K_{j}'\subset {\mathring{ K }}_{m_{1}}\cup {\mathring{ K }}_{m_{2}}\cup\dots \cup {\mathring{ K }_{m_{N_{j}}}}={\mathring{ K }}_{M_{N_{j}}}.
$$
...
Soit $I=(a,b)$ un intervalle ouvert, $E\subset \mathbf{R}$ ouvert et $f=f(t,x)$ continue avec $t\in I$ et $x \in E$. On cherche une fonction $u:I\to \mathbf{R}$ de classe $C^{1}$ telle que 
$$
