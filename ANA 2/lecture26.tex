...
$$
alors $(C^{0}(J_{\delta}),\lVert _{C^{0}} \rVert)$ est un espace vectoriel norme qu'on dit complet (c-a-d toute suite de Cauchy a une limite). On cherche alors $K\subset C^{0}(J_{\delta})$ tel que $\phi(K)\subseteq K$, $\phi$ soit contractante sur $K$. Comme $\boldsymbol{f}$ est localement lipschitzienne on a 
$$
