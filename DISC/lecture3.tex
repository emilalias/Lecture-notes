\section{Inclusion-exclusion principle} \footnote{Lecture 3}
...
\begin{align*}
|A|-\left|\bigcup _{i=1}^{n}A_{i}\right| & =n!-\binom{n}{1}(n-1)!+\binom{n}{2}(n-2)!-\dots \\
 & =n!-\frac{n!(n-1)!}{1!(n-1)!}+\frac{n!(n-2)!}{2!(n-2)!}-\dots \\
...
$$\left|\bigcup _{i=1}^{n}A_{i}\right|\ge \sum _{s=1}^{\ell}\sum _{J\subset \{ 1,\dots,n \}} (-1)^{s-1}\cdot\left|\bigcap_{j\in J} A_{j}\right|$$
\end{theorem}
\begin{proof}
