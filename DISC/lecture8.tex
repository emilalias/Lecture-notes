...
$$
\psi_{1}(\text{tree})=\text{Prufer code of a tree}
$$
...
$$
\psi_{2}(\text{sequence})=\text{tree}
$$

The maps $\psi_{1}$ and $\psi_{2}$ are inverse to each other.
$$
\psi_{1}\circ\psi_{2}=\mathrm{Id}_{\text{codes}},\quad \psi_{2}\circ\psi_{1}=\mathrm{Id}_{\text{trees}}
$$
\end{theorem}